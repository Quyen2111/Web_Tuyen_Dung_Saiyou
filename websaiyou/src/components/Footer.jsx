        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              ...
              />
              <span className="ml-2 text-xl font-bold">JOB SEARCH</span>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/jobs" className="text-gray-300 hover:text-blue-400 text-sm">
                  Việc Làm
                </Link>
              </li>
              <li>
                <Link to="/resume" className="text-gray-300 hover:text-blue-400 text-sm">
                  Hồ sơ & CV
                </Link>
              </li>
              <li>
